...
test_plan:
  current_focus:
    - "Phase4 UI - Lead detail AI analysis card (summary, suggested trade/project type w/ evidence refs, relevance fit, unknowns, evidence groups, model/timestamp, Generate/Regenerate, failed state) + Discover result AI summary block"
  stuck_tasks: []
  test_all: false
